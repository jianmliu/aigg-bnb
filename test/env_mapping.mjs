...
const env = {
  ...
  PORW_VERIFIER: A, PORW_MEP_REGISTRY: A, PORW_INSTANCES: A, PORW_BEACON: A, PORW_CLAIMS: A, PORW_MARKET: A, PORW_DISPUTES: A, PORW_RELAYS: A, PORW_BATTERY_BUDGET: A, PORW_TOKEN_BATTERY_BUDGET: A, PORW_INVENTORY_SALE: A, PORW_COLLECTION: A, PORW_WHITELIST: A,
...
check("deploymentFromEnv(): chain, rpc, epoch blocks, and every address", d.chainId === 97 && d.rpc === env.PORW_RPC && d.epochBlocks === 800 && d.network === "bsc-testnet" && Object.values(d.addresses).every((x) => x === A) && Object.keys(d.addresses).length === 13);
