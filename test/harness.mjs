...
export const deployCollection = (dep, bounty, key = KEYS[0]) => create(clientsFor(dep, key), "FlyCollection", [keccak256("0x0f"), keccak256("0x0e"), GENESIS.root, 2, FLY_PRICE, 0n, FLY_BREED_FEE, bounty, FLY_TREASURY, dep.addresses.meps, ZERO_ADDR, ZERO_ADDR, ZERO_WORD, ZERO_WORD, ZERO_ADDR, 0]);
