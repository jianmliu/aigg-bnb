...
import {createPublicClient,createWalletClient,http,defineChain,stringToHex} from 'viem';
import {privateKeyToAccount} from 'viem/accounts';
import * as H from './harness.mjs';
import {deployFamilyMesh} from '../js/migrate_family_mesh.mjs';
const anvil=await H.startAnvil(8593),journal='/tmp/aigg-family-mesh-test.json';
try {
