...
import { replaceBlock, pilotBlock, ackBlock, breedingBlock, associationBlock, atlasBlock, selectionBlock, progressBlock, maleBlock, maleInputs } from "../docs/flybnb/build.mjs";
