...
export function deploymentFromEnv() {
  ...
  return { verification: {mode: e.PORW_VERIFICATION_MODE || "legacy"}, batteryApi: e.PORW_BATTERY_API || null, tokenBatteryApi: e.PORW_TOKEN_BATTERY_API || null, chainId: Number(need("PORW_CHAIN_ID")), rpc: need("PORW_RPC"), epochBlocks: Number(e.PORW_EPOCH_BLOCKS || 0), network: e.PORW_NETWORK || String(e.PORW_CHAIN_ID),
