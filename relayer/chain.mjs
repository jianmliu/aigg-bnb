...
import { InstanceRegistryAbi, ClaimManagerAbi, TaskMarketAbi, MEPRegistryAbi, BeaconAbi, RelayRegistryAbi } from "./abi.mjs";
...
export function clients(dep, privateKey = null) {
  ...
  return { chain, pub, wallet, account, instances: c(a.instances, InstanceRegistryAbi), claims: c(a.claims, ClaimManagerAbi), market: c(a.market, TaskMarketAbi), meps: c(a.meps, MEPRegistryAbi), beacon: a.beacon ? c(a.beacon, BeaconAbi) : null, relays: c(a.relays, RelayRegistryAbi) };
}
