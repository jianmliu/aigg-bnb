...
window.appActions = {
  ...
  selectBatteryRoute: F.selectBatteryRoute, quoteBattery: F.quoteBattery, loadBattery: F.loadBattery, fundBattery: F.fundBattery, refundBattery: F.refundBattery, loadFlies: F.loadFlies, breed: F.breed, hatch: F.hatch, rearm: F.rearm, loadGenesis: F.loadGenesis, adopt: F.adopt, settle: F.settle, withdraw: F.withdraw,
};
