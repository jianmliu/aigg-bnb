...
contract VrfSynchronousTaskMarket is SynchronousTaskMarket {
    uint256 public constant admissionVersion = 2;
    VrfAdmission public immutable admission;
    ...
    constructor(
        ...
        admission = new VrfAdmission(i, config, tokens, fees);
    }
    ...
    function _sessionWindow() internal view override returns (uint64) {
        return TASK_TIMEOUT + admission.WAIT_BLOCKS() + admission.ACTIVATION_BLOCKS();
    }
