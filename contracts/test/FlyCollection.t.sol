...
contract FlyCollectionTest is Test {
    ...
    function setUp() public {
        ...
        c = new FlyCollection(BASE_F, BASE_M, root(), 2, PRICE, 0, FEE, BOUNTY, treasury, IMEPRegistry(address(meps)), IInstanceBonding(address(0)), LineageRegistry(address(0)), bytes32(0), bytes32(0));
