...
contract FlyCollectionBondTest is Test {
    ...
    function setUp() public {
        ...
        baseMep = meps.registerMEP(IMEPRegistry.MEP({ modelId: BASE_F, schemeDigest: SCHEME_SKETCH_TILE_KECCAK_V2, execKind: keccak256("aigg:exec:int-lif:v1"), neurons: 139255, synapses: 2700513, synapseRoot: keccak256("syn"), weightsDA: bytes("gnfd://aigg-brains/base.bin") }));
