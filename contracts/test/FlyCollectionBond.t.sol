...
contract FlyCollectionBondTest is Test {
    ...
    function setUp() public {
        ...
        c = new FlyCollection(BASE_F, BASE_M, root(), 2, PRICE, UNIT, FEE, 0, treasury, IMEPRegistry(address(meps)), IInstanceBonding(address(inst)), LineageRegistry(address(0)), baseMep, bytes32(0));
