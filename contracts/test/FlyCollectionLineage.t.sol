...
contract FlyCollectionHarness is FlyCollection {
    constructor(bytes32 f, bytes32 m, bytes32 g, uint32 n, uint256 p, uint256 b, uint256 fee, address t, IMEPRegistry meps, IInstanceBonding i, LineageRegistry l) FlyCollection(f, m, g, n, p, b, fee, 0, t, meps, i, l, bytes32(0), bytes32(0), IRoyaltyMarket(address(0)), 0) {}
